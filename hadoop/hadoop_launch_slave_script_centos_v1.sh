...
# add hadoop master key for authentication
sudo wget -P /opt/hadoop/ https://s3.amazonaws.com/ffhs-bt-bd/hadoop/id_rsa.pub
cat /opt/hadoop/id_rsa.pub >> /home/ec2-user/.ssh/authorized_keys
